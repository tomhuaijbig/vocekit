...
lessThan(QT_MAJOR_VERSION, 6): error("VoceKit requires Qt 6")
...
isEmpty(VOCEKIT_SOURCE_COMMIT): VOCEKIT_SOURCE_COMMIT = 0000000000000000000000000000000000000000
isEmpty(VOCEKIT_SOURCE_TREE_CLEAN): VOCEKIT_SOURCE_TREE_CLEAN = 0
isEmpty(VOCEKIT_BUILD_CONFIGURATION): VOCEKIT_BUILD_CONFIGURATION = unknown
DEFINES += VOCEKIT_SOURCE_TREE_CLEAN=$$VOCEKIT_SOURCE_TREE_CLEAN
DEFINES += VOCEKIT_BUILD_CONFIGURATION=\\\"$$VOCEKIT_BUILD_CONFIGURATION\\\"
DEFINES += VOCEKIT_SOURCE_COMMIT=\\\"$$VOCEKIT_SOURCE_COMMIT\\\"

...
$requiredFiles = @(
    "vocekit.exe", "Qt5Core.dll", "Qt5Gui.dll", "Qt5Widgets.dll",
    "Qt5Network.dll", "Qt5Multimedia.dll", "Qt5WebSockets.dll",
    "libgcc_s_dw2-1.dll", "libstdc++-6.dll", "libwinpthread-1.dll",
    "libeay32.dll", "ssleay32.dll", "platforms\qwindows.dll",
    "audio\qtaudio_windows.dll", "bearer\qgenericbearer.dll",
    "bearer\qnativewifibearer.dll", "mediaservice\dsengine.dll",
    "mediaservice\qtmedia_audioengine.dll", "translations\qt_zh_CN.qm",
...
# The Windows speech helper is an x64 child process and may differ from the x86 app.
...
$loadedDlls = @(
    ...
    "Qt5Multimedia.dll", "Qt5WebSockets.dll", "libgcc_s_dw2-1.dll",

...
canvasOwnsNoVisibleScrollBarsAndPlainWheelDoesNotPan()
{
    ...
    QWheelEvent plainWheel(QPointF(120.0, 120.0), 120, Qt::NoButton,
    ...
    QWheelEvent zoomWheel(QPointF(120.0, 120.0), 120, Qt::NoButton,
                          Qt::ControlModifier, Qt::Vertical);
...
void FunctionCanvasViewTests::zoomRangeIsBoundedAndCanBeReset()
{
    ...
    for (int i = 0; i < 80; ++i)
    {
        QWheelEvent zoomIn(QPointF(120.0, 120.0), 120, Qt::NoButton,
                           Qt::ControlModifier, Qt::Vertical);
    ...
    for (int i = 0; i < 160; ++i)
    {
        QWheelEvent zoomOut(QPointF(120.0, 120.0), -120, Qt::NoButton,
                            Qt::ControlModifier, Qt::Vertical);
